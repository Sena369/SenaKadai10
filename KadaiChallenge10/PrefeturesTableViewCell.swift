...
class PrefeturesTableViewCell: UITableViewCell {
    ...
    func configure(name: String, row: Int) {
        ...
        switch row % 3 {
        case 0:
            backgroundColor = UIColor.init(red: 255/255, green: 100/255, blue: 100/255, alpha: 100/100)
        case 1:
            backgroundColor = UIColor.init(red: 100/255, green: 255/255, blue: 100/255, alpha: 100/100)
        default:
            backgroundColor = UIColor.init(red: 100/255, green: 100/255, blue: 255/255, alpha: 100/100)
        }
    }
}
